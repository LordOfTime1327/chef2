      ...
      <div class="wrapper">
        ...
        <form action="" class="faq-form__form contact-form">
          ...
          <div class="contact-form__item">
            ...
            <textarea type="text" class="contact-form__input contact-form__input_textarea faq-form__input faq-form__input_textarea"></textarea>
          </div>
          <div class="contact-form__item">
            <input type="submit" class="contact-form__submit faq-form__submit" value='<?= the_field( 'btn_form_faq' ); ?>'>
          </div>
        </form>
      </div>
    </div>
