...
<main class="site-main woocommerce-cart cart-page">
  <div class="container">
    ...
    <div class="cart-page__empty">
      <?php if( get_field( 'cart_empty_img' ) ) { ?>
      <div class="cart-page__empty-img-box">
        <img src="<?= get_field( 'cart_empty_img' ); ?>" alt="" class='cart-page__empty-img'>
      </div>
      <?php } ?>
      <?php if( get_field( 'cart_empty_text' ) ) { ?>
      <p class="cart-page__empty-text"><?= get_field( 'cart_empty_text' ); ?></p>
      <?php } ?>
      <a href="<?= home_url('/catalog'); ?>" class="cart-page__empty-link btn"><?= get_field( 'cart_empty_btn' ); ?></a>
    </div>
    <?php 
      }
      else {
    ...
    <div class="woocommerce">
      <form class="woocommerce-cart-form cart-form" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
        ...
        <div class="shop_table shop_table_responsive cart woocommerce-cart-form__contents" cellspacing="0">
          ...
          foreach ( WC()->cart->get_cart() as $cart_item_key => $cart_item ) {
            ...
            if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
              ...
              ?>
          <div
            class="woocommerce-cart-form__cart-item <?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?> cart-form__item"">
          ...
          <div class="cart-form__info-box">
            <div class="product-name cart-form__prod-name"
            ...
            <div class="product-quantity cart-form__quantity-box"
        ...
        <div colspan="6" class="actions cart-form__actions">
          <button type="submit" class="button cart-form__update-button" name="update_cart"
