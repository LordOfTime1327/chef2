...
<div class="my-account__orders">
  <?php if ( $customer_orders ) : ?>
    ...
    <!-- Order item -->
      ...
      <div class="my-account__order-item">
        <div class="my-account__order-header">
          ...
          <p class="my-account__order-status <?= "my-account__order-status--" . $order->get_status() ?>"><?= wc_get_order_status_name( $order->get_status() ); ?></p>
        </div>
            ...
            <div class="my-account__order-prod-box">
              <a class="my-account__order-name">
                <div class="my-account__order-img-box">
                  <img src="<?= get_the_post_thumbnail_url( $item -> get_product_id() ); ?>" alt="Simcha card" class="my-account__order-img">
                </div>
        ...
        <div class="my-account__order-footer">
          <p class="my-account__order-total-price"><span class="my-account__order-total-title">Total: </span><?= $order->get_formatted_order_total(); ?></p>
        </div>
      </div>
      <?php endforeach; ?>
    </div>
    ...
    <?php else: ?>
      <div class="my-account__empty-box">
        <div class="my-account__empty-img-box">
          <img src=" <?= get_template_directory_uri() . '/assets/img/empty_orders_list.svg' ?> " alt="" class="my-account__empty-img">
        </div>
        <p class='my-account__empty-text'>No any orders yet</p>
        <a href="#" class='my-account__empty-link'>Go catalog</a>
      </div>
    <?php endif; ?>
  </div>
