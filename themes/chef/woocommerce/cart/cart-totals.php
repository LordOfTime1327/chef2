...
<div class="cart_totals <?php echo ( WC()->customer->has_calculated_shipping() ) ? 'calculated_shipping' : ''; ?>">
  ...
  <div cellspacing="0" class="shop_table shop_table_responsive totals">
    ...
    <div class="shipping">
      ...
      <div data-title="<?php esc_attr_e( 'Shipping', 'woocommerce' ); ?>"><?php woocommerce_shipping_calculator(); ?>
      </div>
    </div>
    ...
    <div class="tax-rate tax-rate-<?php echo esc_attr( sanitize_title( $code ) ); ?>">
      ...
      <div data-title="<?php echo esc_attr( $tax->label ); ?>"><?php echo wp_kses_post( $tax->formatted_amount ); ?>
      </div>
    </div>
    <?php
				}
    ...
    <div class="order-total">
      <?php do_action( 'woocommerce_before_checkout_form', 'woocommerce_checkout_coupon_form', 10 ); ?>
      <div class='order-total__total-box'>
        <div class='order-total__total-price-box'>
          <h2 class='totals__total-title'><?php esc_html_e( 'Total', 'woocommerce' ); ?></h2>
          <div class='totals__total-price' data-title="<?php esc_attr_e( 'Total', 'woocommerce' ); ?>">
            <?php wc_cart_totals_order_total_html(); ?>
          </div>
        </div>


        <div class="wc-proceed-to-checkout totals__btn">
